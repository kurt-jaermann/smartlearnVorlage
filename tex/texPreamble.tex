...
\newcommand{\callout}[2]{
	...
	\begin{addmargin}[-20mm]{0pt}
		\colorbox{calloutBackground}{
			...
			\end{minipage}\hfill
			\begin{minipage}[t]{\dimexpr\textwidth} % 60mm des Bildes + 10mm abstand
...
\chead{Kopfzeile Mitte iet-gibb How-To Seite \pagemark/\pageref*{LastPage}}
\ohead{Kopfzeile aussen}
